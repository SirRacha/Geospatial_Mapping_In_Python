...
if __name__ == '__main__':
    ...
    pizza_df = pandas.read_csv('PizzaEssentials_Reduced.csv')
    ...
    for outer_idx, outer_var in enumerate(ndarray_values[0:,0:2]):
        ...
        for inner_idx, inner_var in enumerate(ndarray_values[0:,0:2]):
            ...
            # FOR HAVERSINE
            my_matrix[outer_idx][inner_idx] = haversine(outer_var, inner_var) * 1000 
            # FOR EUCLIDEAN
    ...
    results_dataframe.to_csv("test5.csv")
